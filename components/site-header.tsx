        ...
        <div className="flex min-h-[4.5rem] items-center justify-between gap-3 py-2">
          <Link href="/" className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0 leading-none">
              <span className="block text-lg font-serif font-bold tracking-tight text-primary md:text-xl lg:text-2xl">
                Golden Eagle
              </span>
              <span className="hidden text-[11px] text-primary/65 lg:block">Insurance & Investments</span>
            </div>
          </Link>

          {/* Desktop Navigation */}
          <nav className="glass-panel hidden shrink rounded-full border border-primary/10 px-2 py-1 shadow-[0_6px_24px_rgba(10,29,55,0.08)] md:flex">
            {navItems.map((item) => {
